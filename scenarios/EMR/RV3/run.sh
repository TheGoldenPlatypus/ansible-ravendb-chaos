#!/usr/bin/env bash
# scenarios/EMR/RV3/run.sh -- teardown + T4-extended lab (5 clusters, 21 nodes) + rv3.yml.
...
step "rv3"; ansible-playbook scenarios/EMR/RV3/rv3.yml "${C[@]}" -e v_new_build="$V_NEW" "${EXTRA[@]}"
